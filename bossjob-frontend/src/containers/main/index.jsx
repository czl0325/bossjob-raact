    ...
    return (
      <div style={{ position: 'fixed', height: '100%', width: '100%', top: 0 }} >
        <TabBar tintColor="#53beb8" tabBarPosition="bottom">
          ...
          <TabBar.Item title="我的" key="me" icon={<i style={{fontSize: '28px'}} className="iconfont icon-me"/>} selectedIcon={<i style={{fontSize: '28px'}} className="iconfont icon-me"/>} selected={this.state.selectTab==="me"} onPress={()=>{ this.setState({selectTab: "me"}) }}>{this.renderContent("我的")}</TabBar.Item>
        </TabBar>
      </div>
    )
  }
